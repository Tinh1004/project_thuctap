export const albums = [
    {
        name: "Music At Party",
        author: "Alan Walker, Andromedik, Ascence, Cartoon, Clarx & Harddope, Disfigure, Different Heaven",
        id: 0,
        links: {
            images: [
                {
    ...
    {
        name: "Music at work",
        author: "Julius Dreisig, Jarico, Janji, Jim Yosef & Valentina Franco, Electro-Light, ulius Dreisig & Zeus X Crona",
        id: 1,
        links: {
            images: [
                {
